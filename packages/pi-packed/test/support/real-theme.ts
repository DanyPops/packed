 ...
 * visible line width or otherwise needs genuine terminal rendering behavior, not a bracket-marker
 * fake theme that isn't equivalent to a real Theme for that purpose.
 */
